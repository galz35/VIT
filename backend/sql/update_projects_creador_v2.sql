...
-- 1. sp_Proyectos_Listar (Robust Join)
...
BEGIN
    ...
    SELECT 
        ...
        p.responsableCarnet,
        p.creadorCarnet,
        creadorNombre = COALESCE(u1.nombre, u2.nombre), -- Robust join
        p.tipo,
...
-- 2. sp_Proyecto_ObtenerVisibles (Robust Join)
...
-- 3. sp_ObtenerProyectos (Robust Join)
