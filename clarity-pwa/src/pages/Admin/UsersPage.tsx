...
import { ArrowLeft, Users, Download, Edit3, X, Network, ChevronRight, ChevronDown, UserPlus, FolderPlus, Key, ToggleLeft, ToggleRight, Eye } from 'lucide-react';
                                                ...
                                                <tr key={u.idUsuario} className="hover:bg-slate-50/50 transition-colors group">
                                                    <td className="p-4 font-bold text-slate-800">
                                                        <div className="flex items-center gap-3">
                                                            <div className="w-9 h-9 rounded-xl bg-indigo-50 text-indigo-600 flex items-center justify-center font-black text-sm border border-indigo-100 shadow-sm">
                                                                {(u.nombre || 'U').charAt(0)}
                                                            </div>
                                                            {u.nombre}
                                                        </div>
