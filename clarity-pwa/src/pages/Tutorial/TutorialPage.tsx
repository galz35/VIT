...
const TUTORIAL_MODULES: TutorialModule[] = [
    {
        ...
        description: 'Qué es Momentus y cómo empezar',
        icon: <BookOpen />,
        color: 'bg-blue-500',
        gradient: 'from-blue-500 to-cyan-500',
        lessons: [
            {
                title: '¿Qué es Momentus?',
                duration: '3 min',
                content: (
                    <div className="space-y-6">
                        <div className="bg-blue-50 p-6 rounded-2xl border border-blue-100">
                            ...
                            <p className="text-blue-700">
                                Momentus es una herramienta para organizar tu trabajo. Te ayuda a saber qué hacer cada día
                ...
                content: (
                    <div className="space-y-6">
                        <div className="bg-emerald-50 p-5 rounded-2xl border border-emerald-100">
                            ...
                            <p className="text-emerald-700">Abre Momentus y decide qué vas a hacer hoy. Toma solo 2 minutos.</p>
                        </div>
                ...
                content: (
                    <div className="space-y-6">
                        <div className="bg-purple-500 p-5 rounded-2xl text-white">
                            <h4 className="font-bold text-lg mb-2">Tu trabajo como jefe en Momentus:</h4>
